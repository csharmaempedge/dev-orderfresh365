...
$config['csrf_token_name'] = 'csrf_armycollage';
$config['csrf_cookie_name'] = 'csrf_cookie_armycollage';
...
$config['captcha_path'] = 'captcha_img/';
$config['captcha_fonts_path'] = 'webroot/img/captcha_img/font/captcha4.ttf';
$config['captcha_width'] = 140;
$config['captcha_height'] = 60;
$config['captcha_font_size'] = 40;
