                                                                  ...
                                                                  <tr>
...

                                                                      {
                                                                        ...
                                                                        <td width="300px;">
                                                                          ...
                                                                          <div class='input-group'>
                                                                              ...
                                                                              <input placeholder="0.00" type="text" required data-validation="number" data-validation-allowing="float" min="0" name="distance_charge_<?php echo $res->address_id; ?>" class="form-control" value="<?php echo (!empty($res->distance_charge)) ? $res->distance_charge : '0'; ?>">
...

                                                                      {
                                                                        ...
                                                                        <td width="300px;">
                                                                          ...
                                                                          <input  type="text" readonly class="form-control" value="<?php echo (!empty($res->address_route)) ? $res->address_route : '0'; ?>">
                                                                        ...
                                                                        <td width="300px;">
                                                                          ...
                                                                          <div class='input-group'>
                                                                              ...
                                                                              <input placeholder="0.00" type="text" readonly class="form-control" value="<?php echo (!empty($res->distance_charge)) ? $res->distance_charge : '0'; ?>">
                                                                      ...
                                                                      <td width="200px;">
...

                                                                        {
                                                                            ...
                                                                            {  
                                                                                ...
                                                                                echo $address_approval_status  .='<span  style="font-size: 15px;" class="label label-danger fa-1x">Pending</span>';
