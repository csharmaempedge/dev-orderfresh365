                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input text">
                                                    ...
                                                    <input onchange="checkMobileNo(this.value)" required="required" name="user_mobile_no" id="user_mobile_no" class="form-control" type="number" min="0" value="<?php echo $value->user_mobile_no; ?>" />
