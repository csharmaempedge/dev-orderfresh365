            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="panel panel-info" style="box-shadow: none; background-color: #dfe7f1;">
                        <div class="panel-heading" style="background-color: #bad59c; color: #22255a;">Patient Macro History</div>
                        <div class="panel-body">
                                <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="login_form">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <?php
                                        $patient_macro_his_res = $this->common_model->getData('tbl_patient_macro_history', array('patient_id'=>$patient_id), 'multi',NULL, NULL, NULL, 'patient_macro_from_date');
                                        if(!empty($patient_macro_his_res))
                                        {
                                            ?>
                                            <div class="row">
                                                <div class="col-md-12">
                                                        ...
                                                        <table id="example" class="table table-bordered table-striped">
                                                            <thead>
                                                                <tr class="label-primary1">
                                                                    ...
                                                                    <th style="background-color: #007775; color: #fff;">Macro's</th>
                                                            ...
                                                            <tbody>
                                                                <?php
                                                                    $i = 1;
                                                                    foreach ($patient_macro_his_res as  $res) 
                                                                    {
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <?php
                                                                                echo $res->patient_macro_from_date.'<b> To </b>'.$res->patient_macro_to_date;
                                                                                ?>
                                                                            </td>
                                                                            <td>
                                                                              <?php
                                                                              $macro_date_res = $this->common_model->getData('tbl_patient_macro_history', array('patient_macro_from_date'=>$res->patient_macro_from_date,'patient_id'=>$patient_id), 'multi');
                                                                              if(!empty($macro_date_res))
                                                                              {
                                                                                $macro = array();
                                                                                foreach ($macro_date_res as $p_res) 
                                                                                {
                                                                                    $macro_res = $this->common_model->getData('tbl_macro', array('macro_id'=>$p_res->macro_id), 'single');
                                                                                    echo $macro[] = '<b style="color: red;">'.$macro_res->macro_name.'</b> <b> '.$p_res->macro_value_id.' </b>';
                                                                                }
                                                                              }
                                                                              ?>
                                                                            </td>
