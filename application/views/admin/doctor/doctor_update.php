                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <div class="input text">
                                                    ...
                                                    <input onchange="check_user_email_address(this.value)" required="required" data-validation="email" name="user_email" id="user_email" class="form-control" type="email" value="<?php echo $value->user_email; ?>" />
                                        ...
                                        <div class="row">
                                            <div class="form-group col-md-4">
                                                <div class="input text">
                                                    ...
                                                    <input onchange="checkMobileNo(this.value)" required="required" data-validation="number length" data-validation-length="10"  data-validation-error-msg="Phone no. has to be 10 chars" name="user_mobile_no" id="user_mobile_no" class="form-control" type="number" min="0" value="<?php echo $value->user_mobile_no; ?>" />
