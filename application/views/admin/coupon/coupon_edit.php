<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update Coupon Code</li>
        ...
        <div class="box box-success">
            ...
            <div class="box-header">
                ...
                <div class="pull-left">
                    ...
                    <h3 class="box-title">Update Coupon Code</h3>
                                        ...
                                        <div class="item form-group col-md-6">
                                            ...
                                            <div class="input text">
                                               ...
                                               <label>Coupon Code Name<span class="text-danger">*</span></label>
                                                ...
                                                <input name="coupon_code_name" required="required" class="form-control" type="text" id="coupon_code_name" placeholder="Enter Coupon Code name" value="<?php echo $coupon_code_edit->coupon_code_name; ?>" />
                                        ...
                                        <div class="item form-group col-md-6">
                                            ...
                                            <div class="input text">
                                               ...
                                               <label>Coupon Code<span class="text-danger">*</span></label>
                                                ...
                                                <input readonly name="coupon_code" required="required" class="form-control" type="text" id="coupon_code" placeholder="Enter Coupon Code name" value="<?php echo $coupon_code_edit->coupon_code; ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class='input-group'>
                                                ...
                                                <input required data-validation="custom" data-validation-regexp="^([0-9]+)$" autocomplete="off" type="text" min="0" name="coupon_code_amount" class="form-control" value="<?php echo $coupon_code_edit->coupon_code_amount; ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <label>Coupon Code Expiry Date<span class="text-danger">*</span></label>
                                               ...
                                               <input autocomplete="off" data-validation="date" type="text" name="coupon_code_expiry_date" id="coupon_code_expiry_date" class="form-control current_date_val" value="<?php echo $coupon_code_edit->coupon_code_expiry_date; ?>">
