                                        ...
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                               <label>Category Name<span class="text-danger">*</span></label>
                                                <input name="category_name" required="required" class="form-control" type="text" id="category_name" placeholder="Enter Category name" value="<?php echo $category_edit->category_name; ?>" />
