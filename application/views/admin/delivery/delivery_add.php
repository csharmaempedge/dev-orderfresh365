<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="<?php echo base_url().MODULE_NAME;?>delivery">Delivery Person</a></li>
            <li class="active">Create Delivery Person</li>
        </ol>
    </section>
   <!-- Main content -->
    <section class="content">       
        <div class="box box-success">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title">Create Delivery Person</h3>
                </div>
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                               <label>Delivery Person Name<span class="text-danger">*</span></label>
                                                <input name="delivery_person_name" required="required" class="form-control" type="text" id="delivery_person_name" placeholder="Enter Delivery Person Name" value="<?php echo set_value('delivery_person_name'); ?>" />
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <div class="input text">
                                                <label>Address</label>
                                                <textarea  name="delivery_person_address" id="delivery_person_address" class="form-control"><?php echo set_value('delivery_person_address'); ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
