                        ...
                        <div class="box-body">
                              ...
                              <div >
                                  ...
                                  <div class="form-group col-md-2" style="margin-top: 30px;">
                                     <div class="input text">
                                          ...
                                          <a class="btn btn-danger btn-sm" href="<?php echo base_url().MODULE_NAME;?>order/bulkPrintView">Refresh Filter</a>
                                     </div>
                                  </div> 
                              </div>
                            </div>
                            <div class="table-responsive">
                              <table class="table table-bordered table-striped">
                                  <thead>
                                      <tr>
                                        <th style="background-color: #bad59c; color: #22255a;">Print Meal Label</th>
                                        <th style="background-color: #bad59c; color: #22255a;">Print Breakfast Label</th>
                                      </tr>
                                      <hr>
                                  <tbody>
                                    <tr>
                                      <td>
                                        <span class="btn btn-success btn-sm" id="Search" onclick="bulkPrintLabel();">Print Meal Label</span>
                                      </td>
                                      <td>
                                        <span class="btn btn-danger btn-sm" id="Search" onclick="bulkBreakfastPrintLabel();">Print Breakfast Label</span>
