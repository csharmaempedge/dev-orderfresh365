	            ...
	            { 
            		...
            		foreach ($order_list as $p_val) {
            			...
            			if($row_count == 1){
            				...
            				<table cellpadding="0" cellspacing="0" align="center" valign="top" style="border: 0px solid lightgrey; page-break-inside: avoid;vertical-align:middle;width: 100%; width: 453.81px;padding:0px;background-color: #f2f2f2; height: 688.8px; border-spacing: 0px;">
            			...
            			?>
	            			...
	            			<td align="center" style="padding: 0px;">
								...
								<div style="width: 357.81px; border:1px solid #ddd;border-radius: 16px;margin:auto 0;background-color:#ffffff;text-align:left;padding:10px;font-family: verdana; height: 118.56px;">

									<div style="margin-top:0px;margin-left: 3px;line-height: 1;margin-right: 100px;height: 40px;">

										<font style="font-size: 12px"><p style="margin: 0 0px 5px ;"><b>Client&nbsp;&nbsp;-&nbsp;<?php echo (!empty($patient_res)) ? $patient_res->user_fname.' '.$patient_res->user_lname : ''; ?></b></p></font>

										<font style="font-size: 12px;"><p style="margin: 0 0px 5px ;"><b>
									...
									<div style="width: 62px;margin-top: -38px;height: 30px;margin-left: 270px;line-height: 1;text-align: right; position: relative;  top: 0px;">
									...
									<div style="margin-top: 0px; margin-left: 0px;">
										...
										<table style="font-size: 10px; width: 100%;">
											...
											<tr>
												...
												<th style="padding: 0px; width: 100px; text-align: left;     padding-bottom: 1px;" >Serving</th>
...

												{
...

													{
														...
														<th style="padding: 0px; width: 60px; text-align: left;     padding-bottom: 1px;" ><?php echo $l_res->label_name; ?></th>
            			...
            			if($row_count%5 == 0){
	            			...
	            			<table cellpadding="0" cellspacing="0" align="center" valign="middle" style="border: 0px solid lightgrey;page-break-inside: avoid;vertical-align:middle;width: 453.81px;padding:0px;background-color: #f2f2f2;height: 688.8px; border-spacing: 0;">
