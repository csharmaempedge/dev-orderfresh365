			...
			<div class="sectionHeader" >
				...
				<div class="headerLeft" style=" width: 70%;">
					...
					<h6>
						...
						<?php 
						$order_res = $this->common_model->getData('tbl_order', array('order_id'=>$p_val->order_id), 'single');
				...
				<table>
					...
					<tbody>
...

						{
							...
							$order_p_res = $this->common_model->getData('tbl_order_product', array('patient_id'=>$p_val->patient_id,'unique_no'=>$p_val->unique_no), 'multi');
