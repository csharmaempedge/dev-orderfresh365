<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Create Macro's</li>
        </ol>
    </section>
   <!-- Main content -->
    <section class="content">       
        <div class="box box-success">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title">Create Macro's</h3>
                </div>
                                        ...
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                               <label>Macro's Name<span class="text-danger">*</span></label>
                                                <input name="macro_name" required="required" class="form-control" type="text" id="macro_name" placeholder="Enter Macro's name" value="<?php echo set_value('macro_name'); ?>" />
                                            </div>
                                        </div>
                                                    ...
                                                    <?php
                                                        ...
                                                        if(!empty($macro_value_res)){
                                                            foreach($macro_value_res as $res){
                                                                ?>
                                                                <option value="<?php echo $res->macro_value_id; ?>"><?php echo $res->macro_value_name; ?></option>
                                                                <?php
                                                            }
                                                        }
                                                    ?>
