<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update  Vision</li>
        </ol>
    </section>
    <!-- Main content -->
    <section class="content">       
        <div class="box box-success">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title">Update  Vision</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="item form-group col-md-6">
                            <div class="input text">
                                ...
                                <input autocomplete="off" name="vision_title" data-validation="required" class="form-control" type="text" id="vision_title" placeholder="Enter Vision Title" value="<?php echo !empty($vision_res->vision_title) ? $vision_res->vision_title : ''; ?>" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            <div class="input text">
                               ...
                               <input data-validation="mime size" data-validation-allowing="jpg, png, gif, jpeg, jpe" data-validation-max-size="3M" type="file" name="vision_img">
                            </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <div class="input text">
                                ...
                                <textarea autocomplete="off" name="vision_small_description" id="vision_small_description" placeholder="Enter Vision Small Description" class="form-control"><?php echo !empty($vision_res->vision_small_description) ? $vision_res->vision_small_description : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            <div class="input text">
                                ...
                                <textarea autocomplete="off" name="vision_long_description" id="vision_long_description" placeholder="Enter Vision Long Description" class="form-control tiny_textarea"><?php echo !empty($vision_res->vision_long_description) ? $vision_res->vision_long_description : ''; ?></textarea>
                            </div>
                        </div>
                    </div>
                    <!-- /.box-body -->      
