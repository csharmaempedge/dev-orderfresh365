<aside class="right-side">
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Update Standard Meal</li>
        </ol>
    </section>
   <!-- Main content -->
    <section class="content">       
        <div class="box box-success">
            <div class="box-header">
                <div class="pull-left">
                    <h3 class="box-title">Update Standard Meal</h3>
                </div>
                                        ...
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                               <label>Protien Serving<span class="text-danger">*</span></label>
                                                <input name="protien_serving" required data-validation="custom" data-validation-regexp="^([0-9]+)$" class="form-control" type="text" id="protien_serving" placeholder="Enter Protien Serving" value="<?php echo $meal_edit->protien_serving; ?>" />
                                            </div>
                                        </div>
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                               <label>Carb Serving<span class="text-danger">*</span></label>
                                                <input name="carb_serving" required data-validation="custom" data-validation-regexp="^([0-9]+)$" class="form-control" type="text" id="carb_serving" placeholder="Enter Carb Serving" value="<?php echo $meal_edit->carb_serving; ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                               <label>Veg Serving<span class="text-danger">*</span></label>
                                                <input name="veg_serving" required data-validation="custom" data-validation-regexp="^([0-9]+)$" class="form-control" type="text" id="veg_serving" placeholder="Enter Veg Serving" value="<?php echo $meal_edit->veg_serving; ?>" />
                                            </div>
                                        </div>
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                                <label>Price <span class="text-danger">*</span></label>
                                                <input name="price" required data-validation="number" data-validation-allowing="float" min="0" class="form-control" type="text" id="price" placeholder="Enter Price" value="<?php echo $meal_edit->price; ?>" />
