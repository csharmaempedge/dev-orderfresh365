                            ...
                            <form action="" id="login_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                               <label>Product Name<span class="text-danger">*</span></label>
                                                <input name="product_name" required="required" class="form-control" type="text" id="product_name" placeholder="Enter Product name" value="<?php echo set_value('product_name'); ?>" />
                                            </div>
                                        </div>
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                                <label>Price per Ounce <span class="text-danger">*</span></label>
                                                <input name="product_price"  required data-validation="number" data-validation-allowing="float" min="0" class="form-control" type="text" id="product_price" placeholder="0.00" value="<?php echo set_value('product_price'); ?>" />
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6" id="breakfast_type_div" style="display: none;">
                                            <div class="input text">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class='input-group'>
                                                <input required data-validation="custom" data-validation-regexp="^([0-9]+)$" autocomplete="off" type="text" min="0" name="product_plus_percentage" class="form-control" value="<?php echo set_value('product_plus_percentage'); ?>">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <div class="input text">
                                                <input required data-validation="number" data-validation-allowing="float" autocomplete="off" type="text" min="1" name="product_row_amount" class="form-control" value="<?php echo set_value('product_row_amount'); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label>Number of portions<span class="text-danger">*</span></label>
                                            <div class="input text">
                                                <input required data-validation="number" data-validation-allowing="float" autocomplete="off" type="text" min="0" name="no_of_portions" class="form-control" value="<?php echo set_value('no_of_portions'); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="item form-group col-md-6">
                                            <div class="input text">
                                               <label>Product Label Print Name<span class="text-danger">*</span></label>
                                                <input maxlength="25"name="product_label_print_name" required="required" class="form-control" type="text" id="product_label_print_name" placeholder="Enter Product Label Print Name" value="<?php echo set_value('product_name'); ?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
