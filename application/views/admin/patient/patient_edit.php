                    ...
                    <div class="panel panel-info" style="box-shadow: none; background-color: #dfe7f1;">
                        ...
                        <div class="panel-heading" style="background-color: #bad59c; color: #22255a;">Patient    
                            ...
                            <?php
                              ...
                              <!-- <input readonly style="color: #4f28e8f2;" type="" name="" value="<?php echo (!empty($set_macro)) ? $set_macro : ''; ?>" > -->
                            ...
                            ?>
                                ...
                                <form action="" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="login_form">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input text">
                                                    ...
                                                    <input name="user_fname" id="user_fname" class="form-control" type="text" value="<?php echo $value->user_fname; ?>" />
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input text">
                                                    ...
                                                    <input name="user_lname" id="user_lname" class="form-control" type="text" value="<?php echo $value->user_lname; ?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input text">
                                                    ...
                                                    <input onchange="check_user_email_address(this.value)" name="user_email" id="user_email" class="form-control" type="email" value="<?php echo $value->user_email; ?>" />
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input text">
                                                    ...
                                                    <input onchange="checkMobileNo(this.value)" name="user_mobile_no" id="user_mobile_no" class="form-control" type="number" min="0" value="<?php echo $value->user_mobile_no; ?>" />
                                                ...
                                                <div class="input text">
                                                    ...
                                                    <select name="state_id" class="form-control" id="state_id">
                                                        ...
                                                        <?php
                                                            ...
                                                            $state_res= $this->common_model->getData('tbl_state', array('country_id'=>'223'), 'multi');
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input text">
                                                    ...
                                                    <input name="user_city" id="user_city" class="form-control" type="text" value="<?php echo $value->user_city; ?>" />
                                            ...
                                            <div class="form-group col-md-4">
                                                ...
                                                <div class="input text">
                                                    ...
                                                    <input name="user_postal_code" id="user_postal_code" class="form-control" type="text" value="<?php echo $value->user_postal_code; ?>" />
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <a class="btn btn-danger btn-sm" href="<?php echo base_url().MODULE_NAME;?>patient">Cancel</a>
