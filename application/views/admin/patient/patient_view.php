            ...
            <div class="box-header">
                <div class="pull-right box-tools">
                    <!-- <?php
                        ...
                        ?>
                            <a href="<?php echo base_url().MODULE_NAME;?>patient/addPatient" class="btn btn-info btn-sm">Add New</a>              
                        <?php
                        }
                    ?>   -->                  
                </div>
                    ...
                    <table id="load_userlist" class="table table-bordered table-striped">
                        <thead>
                            <tr class="label-primary1">
                                ...
                                <!-- <th style="background-color: <?PHP echo THEME_COLOR; ?>; color: #22255a;">View Macro</th> -->
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        $('#load_userlist').DataTable({ 
            ...
            "order": [],
            "ajax": {
                "url": "<?php echo base_url(MODULE_NAME.'patient/loadUserListData')?>",
                "type": "POST",
                "dataType": "json",
