                                    ...
                                    <div class="box-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-4">
                                                <div class="input text">
                                                    <label>State</label>
                                                    <select disabled class="form-control" id="state_id">
                                                        <option value="">-- Select --</option>
                                                        <?php
                                        ...
                                        <div class="row"> 
                                            <div class="form-group col-md-4">
                                                <div class="input text">
                                                    ...
                                                    <br>
                                                    <label><input <?php if($value->email_reminder == 'ON'){ echo "checked"; } ?> disabled name="email_reminder" id="email_reminder"type="radio"  value="ON" /> <b>ON</b></label>&nbsp;&nbsp;&nbsp;&nbsp;  
                                                    <label><input <?php if($value->email_reminder == 'OFF'){ echo "checked"; } ?> disabled name="email_reminder" id="email_reminder"type="radio" value="OFF" /> <b>OFF</b></label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <div class="input text">
                                                    ...
                                                    <br>
                                                    <label><input <?php if($value->text_reminder == 'ON'){ echo "checked"; } ?> disabled name="text_reminder" id="text_reminder"type="radio"  value="ON" /> <b>ON</b></label>&nbsp;&nbsp;&nbsp;&nbsp;  
                                                    <label><input <?php if($value->text_reminder == 'OFF'){ echo "checked"; } ?> disabled name="text_reminder" id="text_reminder"type="radio" value="OFF" /> <b>OFF</b></label>
                                                </div>
                                            </div>
                                            <div class="form-group col-md-4">
                                                <div class="input text">
