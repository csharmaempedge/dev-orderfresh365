                        ...
                        <div class="panel-body">
                            ...
                            <form action="" id="login_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                        ...
                                        <div class="item form-group col-md-12">
                                            ...
                                            <div class="input text">
                                               ...
                                               <label>Address Name<span class="text-danger">*</span></label>
                                                ...
                                                <input data-validation="required" autocomplete="off" id="autocomplete" placeholder="Enter your address" name="user_address" onFocus="geolocate()" class="form-control has-border" type="text" value="<?php echo $address_edit->user_address; ?>"/>
                                    ...
                                    <input type="hidden" name="txtLat" id="txtLat" value="<?php echo (!empty($address_edit->user_latitude)) ? $address_edit->user_latitude : ''; ?>" >
                                    <input type="hidden" name="txtLng" id="txtLng" value="<?php echo (!empty($address_edit->user_longitude)) ? $address_edit->user_longitude : ''; ?>" >
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div id="map"></div>
...
function initAutocomplete() {
  ...
  var myCenter = new google.maps.LatLng(<?php echo (!empty($address_edit->user_latitude)) ? $address_edit->user_latitude : '33.883991'; ?>, <?php echo (!empty($address_edit->user_longitude)) ? $address_edit->user_longitude : '-84.514374'; ?>);
  var mapOptions = {
    center: myCenter,
    zoom: 10
  };
