            ...
            <div class="box-header">
                <div class="pull-right box-tools">
                    <?php
                        ...
                        ?>
                            <a href="<?php echo base_url().MODULE_NAME;?>masterAdmin/addMasterAdmin" class="btn btn-info btn-sm">Add New</a>              
                        <?php
                        }
                    ?>                    
                </div>
...
<script type="text/javascript">
    function getFullSizePic(Imgurl){
        document.getElementById('myModal').innerHTML ='<div class="modal-dialog"><div class="modal-content"><div class="modal-header"><button type="button" class="close" data-dismiss="modal">&times;</button><h4 class="modal-title">Sub Admin</h4></div><div class="modal-body"><img src ="'+Imgurl+'" style="width:100%;height:100%"></div><div class="modal-footer"><button type="button" class="btn btn-default" data-dismiss="modal">Close</button></div></div></div>"';
    }
