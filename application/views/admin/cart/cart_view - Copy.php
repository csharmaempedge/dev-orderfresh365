      ...
      var session_patient_id      = $('#session_patient_id').val();
        ...
        var PAGE = '<?php echo base_url();?>admin/cart/addressWiseDistanceCharge';        
            ...
            { 
                ...
                /*$("#distanse_realod_sec").load(" #distanse_realod_sec");
                $("#distanse_realod_sec1").load(" #distanse_realod_sec1");
                $("#distanse_realod_sec2").load(" #distanse_realod_sec2");
                $("#distanse_realod_sec3").load(" #distanse_realod_sec3");*/
                location.reload(); 
