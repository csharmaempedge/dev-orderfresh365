...
Security
Insights
web-payments-quickstart/public/app.css
@alexandersmanning
alexandersmanning feat: Add Afterpay walkthrough example (#48)
…
Latest commit 4ce2538 on Feb 16
 History
 3 contributors
@alexandersmanning@JHKennedy4@ptran-sq
 207 lines (175 sloc)  8.33 KB
...
You have no unread notifications
    ...
    ></script>
    <script>
      const appId = "<?php echo SQUAREUP_APPLICATION_ID ;?>";
      const locationId = "<?php echo SQUAREUP_LOCATION_ID ;?>";
